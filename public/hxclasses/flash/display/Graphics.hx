...
@:final extern class Graphics {
	@:require(flash11) var cubicCurveTo(require flash11,require flash11) : Float -> Float -> Float -> Float -> Float -> Float -> Void;
	function new() : Void;
	...
	@:require(flash10) function lineBitmapStyle(bitmap : BitmapData, ?matrix : flash.geom.Matrix, ?repeat : Bool, ?smooth : Bool) : Void;
