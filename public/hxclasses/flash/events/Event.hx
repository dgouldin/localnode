...
extern class Event {
	...
	@:require(flash11) static var CONTEXT3D_CREATE(require flash11,require flash11) : String;
	...
	@:require(flash11) static var TEXT_INTERACTION_MODE_CHANGE(require flash11,require flash11) : String;
